...
public abstract class AbstractDevice extends AbstractServiceProvider {
	...
	public enum DeviceType {
		DEVICE_TYPE_CNCMILLING(1), DEVICE_TYPE_STACKPLATE(2), DEVICE_TYPE_PRAGE(3), DEVICE_TYPE_CONVEYOR(4), DEVICE_TYPE_BIN(5), DEVICE_TYPE_CONVEYOR_EATON(6), DEVICE_TYPE_REVERSAL_UNIT(7), DEVICE_TYPE_UNLOAD_PALLET(8), DEVICE_TYPE_PALLET(9);
