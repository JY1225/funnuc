...
public class FanucRobot extends AbstractRobot {
    ...
    @Override
    public void initiatePut(final RobotPutSettings putSettings, final Clamping clamping) throws AbstractCommunicationException, RobotActionException, InterruptedException {
    ...
    @Override
    public void initiatePick(final RobotPickSettings pickSettings, final Clamping clamping) throws AbstractCommunicationException, RobotActionException, InterruptedException {
        if (isExecutionInProgress()) {
            throw new IllegalStateException("Already performing action, with setting: " + getCurrentActionSettings());
        } else {
            setCurrentActionSettings(pickSettings);
        }
        RobotPickSettings fPickSettings = pickSettings;
    ...
    @Override
    public void writeUserFrame(final RobotUserFrame userframe, final RobotPosition position) throws AbstractCommunicationException, RobotActionException, InterruptedException {
        List<String> values = new ArrayList<String>();
    ...
    @Override
    public void readUserFrame(final RobotUserFrame userframe) throws AbstractCommunicationException,
    ...
    @Override
    public void writeToolFrame(final RobotToolFrame toolFrame, final RobotPosition position) throws AbstractCommunicationException, RobotActionException, InterruptedException {
        List<String> values = new ArrayList<String>();
    ...
    @Override
    public void readToolFrame(final RobotToolFrame toolFrame) throws AbstractCommunicationException,
    RobotActionException, InterruptedException {
        List<String> values = new ArrayList<String>();
        values.add("" + toolFrame.getTfNr());
    ...
    @Override
    public void writeIPPoint(final RobotIPPoint ipPoint, final RobotPosition position) throws AbstractCommunicationException, RobotActionException, InterruptedException {
        List<String> values = new ArrayList<String>();
    ...
    @Override
    public void readIPPoint(final RobotIPPoint ipPoint) throws AbstractCommunicationException, RobotActionException, InterruptedException {
        List<String> values = new ArrayList<String>();
        values.add("" + ipPoint.getUfNr());
        values.add("" + ipPoint.getTfNr());
        values.add("" + ipPoint.getPosType().getId());
    ...
    @Override
    public void writeRPPoint(final RobotRefPoint rpPoint, final RobotPosition position) throws AbstractCommunicationException, RobotActionException, InterruptedException {
        List<String> values = new ArrayList<String>();
    ...
    @Override
    public void readRPPoint(final RobotRefPoint rpPoint) throws AbstractCommunicationException, RobotActionException, InterruptedException {
        List<String> values = new ArrayList<String>();
        values.add("" + rpPoint.getUfNr());
        values.add("" + rpPoint.getTfNr());
        values.add("" + rpPoint.getOriginalTfNr());
    ...
    @Override
    public void writeSpecialPoint(final RobotSpecialPoint specialPoint, final RobotPosition position) throws AbstractCommunicationException, RobotActionException, InterruptedException {
        List<String> values = new ArrayList<String>();
    ...
    @Override
    public void readSpecialPoint(final RobotSpecialPoint specialPoint) throws AbstractCommunicationException, RobotActionException, InterruptedException {
        List<String> values = new ArrayList<String>();
        values.add("" + specialPoint.getId());
    ...
    @Override
    public void readRegister(final RobotRegister register) throws AbstractCommunicationException, RobotActionException, InterruptedException {
        List<String> values = new ArrayList<String>();
    ...
    @Override
    public void enableMovement(final boolean flag) throws AbstractCommunicationException, RobotActionException, InterruptedException {
        List<String> values = new ArrayList<String>();
        if (flag) {
            values.add("" + 1);
