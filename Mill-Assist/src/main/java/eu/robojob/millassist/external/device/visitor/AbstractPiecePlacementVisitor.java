...
public abstract class AbstractPiecePlacementVisitor<T extends IWorkPieceDimensions> {
    ...
    public Coordinates getLocation(AbstractStackPlate stackPlate, SimpleWorkArea workArea, Type type,
    ...
    public Coordinates getPickLocation(PrageDevice device, SimpleWorkArea workArea, T dimensions,
            ClampingManner clampType, ApproachType approachType) {
    ...
    public Coordinates getPutLocation(OutputBin bin, SimpleWorkArea workArea, T dimensions, ClampingManner clampType,
            ApproachType approachType) {
        return workArea.getDefaultClamping().getRelativePosition();
    }

    public Coordinates getPickLocation(OutputBin bin, SimpleWorkArea workArea, T dimensions, ClampingManner clampType,
            ApproachType approachType) {
     ...
     * STACKPLATE
     */
    public Coordinates getPutLocation(AbstractStackPlate stackPlate, SimpleWorkArea workArea, T dimensions,
            ClampingManner clampType, ApproachType approachType) {
        for (StackPlateStackingPosition stackingPos : stackPlate.getLayout().getStackingPositions()) {
    ...
    public Coordinates getPickLocation(AbstractStackPlate stackPlate, SimpleWorkArea workArea, T dimensions,
            ClampingManner clampType, ApproachType approachType) {
        for (StackPlateStackingPosition stackingPos : stackPlate.getLayout().getStackingPositions()) {
            if ((stackingPos.getWorkPiece() != null)
     ...
     * UNLOAD PALLET
     */
    public Coordinates getLocation(UnloadPallet unloadPallet, SimpleWorkArea workArea, Type type,
            ClampingManner clampType) {
    ...
    public Coordinates getPutLocation(UnloadPallet unloadPallet, SimpleWorkArea workArea, T dimensions,
            ClampingManner clampType, ApproachType approachType) {
    ...
    public Coordinates getPutLocation(Pallet pallet, SimpleWorkArea workArea, T dimensions, ClampingManner clampType,
            ApproachType approachType) {
        for (StackPlateStackingPosition stackingPos : pallet.getGridLayout().getStackingPositions()) {
            if (stackingPos.getWorkPiece() == null) {
    ...
    public Coordinates getPickLocation(Pallet pallet, SimpleWorkArea workArea, T dimensions, ClampingManner clampType,
            ApproachType approachType) {
        for (StackPlateStackingPosition stackingPos : pallet.getGridLayout().getStackingPositions()) {
            if ((stackingPos.getWorkPiece() != null)
                    && (stackingPos.getWorkPiece().getType().equals(WorkPiece.Type.RAW))
