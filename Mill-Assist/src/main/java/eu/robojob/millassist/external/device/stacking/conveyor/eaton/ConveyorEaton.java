...
public class ConveyorEaton extends AbstractConveyor {
	...
	private static Logger logger = LogManager.getLogger(ConveyorEaton.class.getName());

	public ConveyorEaton(final String name, final Set<Zone> zones, final WorkAreaManager workAreaA, final WorkAreaManager workAreaB,
	...
	public ConveyorEaton(final String name, final WorkAreaManager workAreaA, final WorkAreaManager workAreaB,
			final ConveyorLayout layout, final SocketConnection socketConnection, final float nomSpeedA, final float nomSpeedASlow, 
			final float nomSpeedB, final float nomSpeedBSlow) {
