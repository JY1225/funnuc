...
public class ProcessFlowManager {
	...
	public ProcessFlow createNewProcessFlow() {
		...
		PickStep pickStep = new PickStep(stackingFromDevice.getDefaultPickSettings(null), robot.getDefaultPickSettings());
		PutStep putStep = new PutStep(cncMachine.getDefaultPutSettings(null), robot.getDefaultPutSettings());
		ProcessingStep processingStep = new ProcessingStep(cncMachine.getDefaultStartCyclusSettings());
		PickStep pickStep2 = new PickStep(cncMachine.getDefaultPickSettings(null), robot.getDefaultPickSettings());
		PutStep putStep2 = new PutStep(stackingToDevice.getDefaultPutSettings(null), robot.getDefaultPutSettings());
		...
		pickStep.getDeviceSettings().setWorkPiece(rawWorkPiece);
		putStep.getDeviceSettings().setWorkPiece(rawWorkPiece);
		processingStep.getDeviceSettings().setWorkPiece(rawWorkPiece);
		pickStep2.getRobotSettings().setWorkPiece(finishedWorkPiece);
		pickStep2.getDeviceSettings().setWorkPiece(finishedWorkPiece);
		putStep2.getDeviceSettings().setWorkPiece(finishedWorkPiece);
