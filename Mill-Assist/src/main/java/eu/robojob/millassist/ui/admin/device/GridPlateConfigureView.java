...
public class GridPlateConfigureView extends AbstractFormView<GridPlateConfigurePresenter> {
	...
	private Label lblName, lblOrientation, lblFirstHole, lblX, lblY, lblOffset, lblOffsetX, lblOffsetY, lblNbRows, lblNbCols, lblCount, lblHeight, lblHoleLength, lblHoleWidth, lblLength, lblWidth, lblDimHoles, lblDimPlate, lblHorizontalPadding, lblVerticalPaddingBottom, lblVerticalPaddingTop, lblHorizontalR, lblTiltedR;
	private NumericTextField numtxtX, numtxtY, numtxtOffsetX, numtxtOffsetY, numtxtHeight, numtxtHoleLength, numtxtHoleWidth, numtxtLength, numtxtWidth, numtxtHorizontalPadding, numtxtVerticalPaddingTop, numtxtVerticalPaddingBottom, numtxtHorizontalR, numtxtTiltedR;
	...
	private static final String HEIGHT = "GridPlateConfigureView.height";
	...
	private static final String HORIZONTALPADDING = "GridPlateConfigureView.horizontalPadding";
	private static final String VERTICALPADDINGTOP = "GridPlateConfigureView.verticalPaddingTop";
	private static final String VERTICALPADDINGBOTTOM = "GridPlateConfigureView.verticalPaddingBottom";
	private static final String HORIZONTAL_R = "GridPlateConfigureView.horizontalR";
	private static final String TILTED_R = "GridPlateConfigureView.tiltedR";
	...
	protected void build() {
		...
		fullTxtName.setMaxWidth(2 * BTN_WIDTH * 0.9);
		...
		btnHorizontal = createButton(HORIZONTAL_ICON, CSS_CLASS_BUTTON_ORIENTATION, Translator.getTranslation(HORIZONTAL), BTN_WIDTH*0.9, BTN_HEIGHT*0.85, new EventHandler<ActionEvent>() {
			@Override
		...
		btnTilted = createButton(TILTED_ICON, CSS_CLASS_BUTTON_ORIENTATION, Translator.getTranslation(TILTED), BTN_WIDTH*0.9, BTN_HEIGHT*0.85, new EventHandler<ActionEvent>() {
			@Override
			public void handle(final ActionEvent event) {
		...
		numtxtHorizontalPadding.setOnChange(new ChangeListener<Float>() {
			@Override
		...
		numtxtVerticalPaddingTop.setOnChange(new ChangeListener<Float>() {
			@Override
			public void changed(final ObservableValue<? extends Float> arg0, final Float arg1, final Float arg2) {
				validate();
			}
		...
		numtxtVerticalPaddingBottom.setOnChange(new ChangeListener<Float>() {
			@Override
			public void changed(final ObservableValue<? extends Float> arg0, final Float arg1, final Float arg2) {
				validate();
			}
		...
		numtxtHorizontalR.setOnChange(new ChangeListener<Float>() {
			@Override
			public void changed(final ObservableValue<? extends Float> arg0, final Float arg1, final Float arg2) {
				validate();
			}
		...
		numtxtTiltedR.setOnChange(new ChangeListener<Float>() {
			@Override
			public void changed(final ObservableValue<? extends Float> arg0, final Float arg1, final Float arg2) {
				validate();
			}
		...
		hboxDimPlate.getChildren().addAll(lblLength, numtxtLength, lblWidth, numtxtWidth);
		...
		btnSave = createButton(SAVE_PATH, CSS_CLASS_FORM_BUTTON, Translator.getTranslation(SAVE), BTN_WIDTH, BTN_HEIGHT, new EventHandler<ActionEvent>() {
			...
			public void handle(final ActionEvent arg0) {
				getPresenter().saveData(fullTxtName.getText(), 
						...
						Float.parseFloat(numtxtHorizontalPadding.getText()), 
						Float.parseFloat(numtxtVerticalPaddingTop.getText()), 
						Float.parseFloat(numtxtVerticalPaddingBottom.getText()), 
						Float.parseFloat(numtxtHorizontalR.getText()), 
						Float.parseFloat(numtxtTiltedR.getText()), 
		...
		gpGridPlateConfig.setVgap(5);
		gpGridPlateConfig.setHgap(15);
		int row = 0;
		...
		gpGridPlateConfig.add(lblHeight, 0, ++row);
		gpGridPlateConfig.add(numtxtHeight, 2, row);
		gpGridPlateConfig.add(lblHorizontalPadding, 4, row);
		gpGridPlateConfig.add(numtxtHorizontalPadding, 5, row);
		gpGridPlateConfig.add(lblHorizontalR,0,++row);
		gpGridPlateConfig.add(numtxtHorizontalR,2,row);
		gpGridPlateConfig.add(lblVerticalPaddingTop, 4, row);
		gpGridPlateConfig.add(numtxtVerticalPaddingTop,5, row);
		gpGridPlateConfig.add(lblTiltedR,0,++row);
		gpGridPlateConfig.add(numtxtTiltedR,2,row);
		gpGridPlateConfig.add(lblVerticalPaddingBottom, 4, row);
		gpGridPlateConfig.add(numtxtVerticalPaddingBottom, 5, row);
		gpGridPlateConfig.add(lblCount, 0, ++row);
		gpGridPlateConfig.add(hboxCount, 2, row, 3, 1);
		gpGridPlateConfig.add(lblDimPlate,0, ++row);
		gpGridPlateConfig.add(hboxDimPlate, 2, row, 3, 1);
	...
	public void reset() {
		...
		numtxtWidth.setText("");
		numtxtHorizontalPadding.setText("");
		numtxtVerticalPaddingTop.setText("");
		numtxtVerticalPaddingBottom.setText("");
		numtxtHorizontalR.setText("");
		numtxtTiltedR.setText("");
	...
	public void validate() {
		if (!fullTxtName.getText().equals("") &&
				...
				!numtxtHorizontalPadding.getText().equals("") &&
				!numtxtVerticalPaddingTop.getText().equals("") &&
				!numtxtVerticalPaddingBottom.getText().equals("") &&
				!numtxtHorizontalR.getText().equals("") &&
				!numtxtTiltedR.getText().equals("") &&
	...
	public void gridPlateSelected(final GridPlateLayout gridPlate) {
		...
		numtxtHorizontalPadding.setText("" + gridPlate.getHorizontalPadding());
		numtxtVerticalPaddingTop.setText("" + gridPlate.getVerticalPaddingTop());
		numtxtVerticalPaddingBottom.setText("" + gridPlate.getVerticalPaddingBottom());
		numtxtHorizontalR.setText("" + gridPlate.getHorizontalR());
		numtxtTiltedR.setText("" + gridPlate.getTiltedR());
