...
public class NodeOverlayView extends AbstractDialogView<NodeOverlayPresenter> {
	...
	protected Node getContents(double height) {
		...
		vboxContents.setPrefSize(WIDTH_PLATE, height);
		vboxContents.setMinSize(WIDTH_PLATE, height);
		vboxContents.setMaxSize(WIDTH_PLATE, height);
		...
		setDialogSize(WIDTH_PLATE, height);
		return vboxContents;
	}
}
