...
public class PalletLayoutPresenter extends AbstractFormPresenter<UnloadPalletLayoutView<PalletLayoutPresenter>, PalletMenuPresenter> implements UnloadPalletListener{

    private static final String NOT_ENOUGH_LAYERS = "UnloadPalletLayoutView.NotEnoughLayers";
    
    private Pallet loadPallet;
    private PutStep putStep;
    private InterventionStep interventionStep;
    
    public PalletLayoutPresenter(UnloadPalletLayoutView<PalletLayoutPresenter> view, final Pallet loadPallet, final PutStep putStep) {
        super(view);
        this.loadPallet = loadPallet;
//        this.loadPallet.addListener(this);
        this.putStep = putStep;
//        getView().setUnloadPallet(loadPallet);
//        getView().build();
    }
...
//        updateIntervention();
    ...
    public void unregister() {
        loadPallet.removeListener(this);
    }
