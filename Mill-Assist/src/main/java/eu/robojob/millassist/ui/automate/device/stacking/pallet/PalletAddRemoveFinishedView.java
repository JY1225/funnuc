...
//        getContents().add(btnMaxFinished, column++, row);
        ...
        setFinishedEditable(getPresenter().getProcessFlow().hasPalletForFinishedPieces());
        setRawEditable(getPresenter().getProcessFlow().hasPalletForRawPieces());
        hideNotification();
    ...
    public void setRawEditable(boolean editable) {
        itfNumberRaw.setManaged(editable);
        lblNumberRaw.setManaged(editable);
        btnMaxRaw.setManaged(editable);
    }
