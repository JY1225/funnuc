...
public class AlarmsPopUpView extends PopUpView<AlarmsPopUpPresenter> {
	...
	private HBox getAlarmHBox(final String message) {
		...
		lblAlarmMessage.setAlignment(Pos.CENTER_LEFT);
		lblAlarmMessage.setTextAlignment(TextAlignment.LEFT);
		hBoxAlarm.setPadding(new Insets(5, 10, 5, 10));
		lblAlarmMessage.setMaxWidth(WIDTH - ICON_WIDTH - ICON_PADDING - 30);
		lblAlarmMessage.setPrefWidth(WIDTH - ICON_WIDTH - ICON_PADDING - 30);
		lblAlarmMessage.setMinWidth(WIDTH - ICON_WIDTH - ICON_PADDING - 30);
