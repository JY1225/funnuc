...
public class BasicStackPlateConfigureView extends AbstractFormView<BasicStackPlateConfigurePresenter> {
	...
	private NumericTextField numTxtMaxUnderflow;
	...
	private static final String MAX_UNDERFLOW = "BasicStackPlateConfigureView.maxUnderflow";
	...
	protected void build() {
		...
		numTxtMaxUnderflow = new NumericTextField(5);
		...
		btnSave = createButton(SAVE_PATH, "", Translator.getTranslation(SAVE), UIConstants.BUTTON_HEIGHT * 3, UIConstants.BUTTON_HEIGHT, new EventHandler<ActionEvent>() {
			...
			public void handle(final ActionEvent arg0) {
				getPresenter().saveData(fulltxtName.getText(), cbbUserFrames.valueProperty().get(), Integer.parseInt(itxtHorizontalHoleAmount.getText()), 
						...
						Float.parseFloat(numTxtMaxOverflow.getText()), Float.parseFloat(numTxtMaxUnderflow.getText()),
		...
		column++;
		getContents().add(lblMaxUnderflow, column++, row);
		getContents().add(numTxtMaxUnderflow, column++, row);
		column = 0; row++;
	...
	public void setTextFieldListener(final TextInputControlListener listener) {
		...
		numTxtMaxUnderflow.setFocusListener(listener);
	...
	public void refresh() {
		...
		if (basicStackPlate != null) {
			...
			itxtHorizontalHoleAmount.setText(basicStackPlate.getBasicLayout().getHorizontalHoleAmount() + "");
			itxtVerticalHoleAmount.setText(basicStackPlate.getBasicLayout().getVerticalHoleAmount() + "");
			numtxtHoleDiameter.setText(basicStackPlate.getBasicLayout().getHoleDiameter() + "");
			numtxtStudDiameter.setText(basicStackPlate.getBasicLayout().getStudDiameter() + "");
			numtxtHorizontalPadding.setText(basicStackPlate.getBasicLayout().getHorizontalPadding() + "");
			...
			numTxtTiltedR.setText(basicStackPlate.getBasicLayout().getTiltedR() + "");
			numTxtMaxOverflow.setText(basicStackPlate.getBasicLayout().getMaxOverflow() + "");
			numTxtMaxUnderflow.setText(basicStackPlate.getBasicLayout().getMaxUnderflow() + "");
