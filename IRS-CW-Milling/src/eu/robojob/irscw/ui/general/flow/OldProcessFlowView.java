...
public class OldProcessFlowView extends GridPane  {
	...
	public void setProcessFlow(final ProcessFlow process) {
	...
	public void buildView() {
		...
		this.setEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent> () {
			...
			public void handle(MouseEvent arg0) {
				OldProcessFlowView.this.requestFocus();
