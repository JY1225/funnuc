...
public class TransportMenuView extends AbstractMenuView<TransportMenuPresenter> {
	...
	protected void build() {
		addMenuItem(0, ICON_GRIP, Translator.getTranslation("ConfigGripers"), true, new EventHandler<ActionEvent>() {
			@Override
			public void handle(final ActionEvent arg0) {
				getPresenter().configureGriper();
			}
		});
		addMenuItem(1, ICON_INTERVENTION, Translator.getTranslation("ConfigInterventions"), true, new EventHandler<ActionEvent>() {
			@Override
			public void handle(final ActionEvent arg0) {
