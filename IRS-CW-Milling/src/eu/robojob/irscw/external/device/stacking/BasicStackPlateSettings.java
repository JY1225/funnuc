...
public class BasicStackPlateSettings extends DeviceSettings {
	...
	public BasicStackPlateSettings(final WorkPiece workPiece, final WorkPiece finishedWorkPiece, final WorkPieceOrientation orientation, final Integer amount) {
		this.amount = amount;
